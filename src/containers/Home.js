...
class Home extends Component {
    ...
    render() {
        ...
        console.log("this.prpos.isLoggedIn : "+ this.props.isLoggedIn);
        var mockData = [
            {
        ...
        return (
            <div className = "wrapper">
                ...
                {console.log("this cur :" + this.props.currentUser)}
                  <MemoList data = {this.props.memoData} currentUser = {this.props.currentUser}></MemoList>
            </div>
        );
    }
...
//리듀서에서 고유 dispatch에서 action기능 수행 및 결과값 리듀서로 전달
